...
int spidev_open(struct inode *inode, struct file *filep)
{
	...
	printk("___+++__++__ open function is invoke...\n");
	return 0;
...
static int __init spi_dev_init(void)
{
				...
				/*
					 ...
					 cdev_alloc() is a older mechanism
					 .this is used for getting cdev structure at runtime of your character driver module .
					 then you have to manually assign operation to ops variable to cdev structure
					 .However cdev_init is the new mechanism in this we have to pass cdev
					 structure variable (or already initialized cdev structure pointer)
					 and file operation variable,for information go here
